...
{
    // Static helper for styling WinForms controls consistently
    internal static class ControlStyler
    {
        // Applies a rounded region to a control for custom corners
        private static void ApplyRoundedRegion(Control c, int radius)
        {
            // Handler to update region on resize
        ...
        // Styles a button with theme colors, rounded corners, and hover effects
        ...
        // Styles a label for either normal or muted appearance
        ...
        // Styles a ComboBox for consistent look
        ...
        // Styles a CheckBox for theme consistency
        ...
        // Styles a DataGridView for theme colors and fonts
