    ...
    public partial class TabbedMainForm : Form
    {
        ...
        private void BuildTabSensitivity()
        {
            ...
            foreach (var c in new[] { saNB_VarSelect, saB_VarSelect, saRHS_ConSelect, saCol_VarSelect })
                StyleCombo(c);
            foreach (var n in new[] { saNB_ApplyDelta, saB_ApplyDelta, saRHS_ApplyDelta }) { n.BackColor = CurCard; n.ForeColor = CurText; }
        ...
        private void BuildTabNodes()
        {
            ...
            lblNodeTitle = new Label { Text = "Node: (select on left)", AutoSize = true, Top = 10, Left = 10, Font = UiFontBold };
